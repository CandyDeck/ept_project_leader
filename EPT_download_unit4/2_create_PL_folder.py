...
#project = pd.read_excel(os.getcwd() + "\\" + str(20230523)+ "\\" + str(20230523) + '_list_project.xlsx','WORKORDERS')
...
# df.to_csv(os.getcwd() + "\\" + str(today.strftime('%Y%m%d'))+ "\\" +'project_number_oppdrag.csv',index=False)
